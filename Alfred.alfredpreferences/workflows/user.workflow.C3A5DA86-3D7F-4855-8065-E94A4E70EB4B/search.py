...
async def search(query):
    ...
    urls = [
        f"https://scholar.google.com.hk/scholar?&q={encoded_query}&start={page}&google_abuse=GOOGLE_ABUSE_EXEMPTION%3DID%3D5996390e8f302f50:TM%3D1597979846:C%3Dr:IP%3D158.132.214.199-:S%3DAPGng0u8PIBYIiJEdJD900VbCQv-pHQ8MA%3B+path%3D/%3B+domain%3Dgoogle.com%3B+expires%3DFri,+21-Aug-2020+06:17:26+GMT"
